...
{
  var e = document.getElementById ('trans-msg');

  e.innerHTML =
    "<button class='close' onclick='document.getElementById(\"trans-msg\").style.display=\"none\"'>&times;</button>"+((title)?"<strong>"+title+"</strong>":'')+"<p>"+msg+"</p>";
...
function translate_console_open (lang2)
{
  lang2 = (lang2) ? lang2.replace (/^([a-z]+).*/i, "$1") : '';
